...
less = int(input('How many containers 1 litter or less do you have: '))
...
# The %.2f format specifier indicates that a value should be formatted as a floating point number
